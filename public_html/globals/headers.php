...
<cms:template title='Headers' order='0' clonable='1' executable='1' parent='globals'>
    <cms:pagebuilder name='headers_pb' label='Headers' skip_custom_fields='1' order='-3'>
        <cms:section label='Menu'        name='section_menu'        masterpage='blocks/menu.php'        mosaic='blocks' tiles='' />
...
<cms:capture into='menu_buffer' >
    <cms:set menu_done='0' />
    <cms:show_pagebuilder 'headers_pb'>
...
<cms:capture into='pb_tile_content' >
    <cms:if "<cms:strlen menu_buffer />"><cms:show menu_buffer /></cms:if>
</cms:capture>
